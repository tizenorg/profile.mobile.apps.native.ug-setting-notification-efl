...
static void gl_radio_sel_cb(void *data, Evas_Object *obj, void *event_info)
{
    ...
    const char *chosen_app = elm_object_item_part_text_get(it, "elm.text");
    NOTISET_DBG("CHOSEN_APP = %s", chosen_app);
}
...
{
    NOTISET_TRACE_BEGIN;
    // TODO: implement realisation when API will be available
}
